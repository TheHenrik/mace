...
\usepackage[
	...
	pdfauthor={Gregor Zwickl},				% Name des Autors
...
\usepackage[ngerman]{babel} 			% Deutsche Normen / Deutscher Sprachraum
...
\include{chapters/03_hauptteil}

\include{chapters/04_ergebnisse}

\include{chapters/09_zusammenfassung_und_ausblick}
